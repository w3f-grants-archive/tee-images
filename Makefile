...
shell_imx8m-compulab: pull_docker
	$(call run_docker,$(SCRIPTS_DIR)/zxshell.sh,imx8m-compulab)
...
build_image_imx8m-compulab: pull_docker
	$(call run_docker,$(SCRIPTS_DIR)/zxbuild.sh,imx8m-compulab)
